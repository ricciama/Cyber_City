        ...
        <asp:Table ID="ScheduleHeader" runat="server" CellPadding="75" CellSpacing="75" HorizontalAlign ="Center">
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Center">
                    <asp:Label ID="lblOrgRepSchedule" runat="server" Text="" Font-Bold="true" Font-Size="XX-Large"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign ="Center">
                    <asp:Label ID="lblScheduleHelper" runat ="server" Text ="This is your Organizational Rep Schedule for CyberDay, if you have any questions feel free to contact us!" Font-Size="Large"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />
