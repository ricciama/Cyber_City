...
namespace CyberCity
{
    public partial class Queries : System.Web.UI.Page
    {
        ...
        protected void ddlProgram_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string schedule = "SELECT Name, LTRIM(RIGHT(CONVERT(VARCHAR(20), Time, 100), 7)) FROM Event WHERE ProgramID = '" + ProgramID.ToString() + "'";
            DataSet ds = new DataSet();
        ...
        protected void ddlOrgRep_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT Event.Name, LTRIM(RIGHT(CONVERT(VARCHAR(20), Event.Time, 100), 7)), Event.Location FROM OrgRep INNER JOIN ";
        ...
        protected void ddlVolunteers_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string query = "SELECT Event.Name, LTRIM(RIGHT(CONVERT(VARCHAR(20), Event.Time, 100), 7)), Event.Location FROM Volunteer INNER JOIN ";
