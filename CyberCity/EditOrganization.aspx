...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
    <asp:Panel ID="pnlEditOrg" runat="server"  BorderColor="#cccccc" BorderStyle="Solid">
        <br />
        <br />
        <asp:Table ID="tblEditOrg" runat="server" HorizontalAlign="Center" CellPadding="50" CellSpacing="50">
            ...
            <asp:TableRow>
                <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                    <div class="form-group">
                         <asp:Button class="btn btn-primary btn-block btn-lg" ID="btnEditOrg" runat="server" Text="Create Program" OnClick="btnEditOrg_Click"/>
                    </div>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
